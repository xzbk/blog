...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<%=basePath%>tag/update" id="form">
                	<input type="hidden" name="uid" value="${user.id }"/>
                	<div class="layui-form-item">
                        <label for="tagid" class="layui-form-label">
                            <span class="x-red">*</span>ID</label>
                        <div class="layui-input-inline">
                            <input type="text" id="tagid" name="id" required="" value="${tag.id }" lay-verify="required" autocomplete="off" readonly="readonly" class="layui-input layui-disabled">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="tagname" name="name" value="${tag.name }" required=""  lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    </div>
			        <div class="layui-form-item">
