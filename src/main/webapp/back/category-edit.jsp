...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<%=basePath%>category/update" id="form">
                	<div class="layui-form-item">
                        <label for="categoryid" class="layui-form-label">
                            <span class="x-red">*</span>ID</label>
                        <div class="layui-input-inline">
                            <input type="text" id="categoryid" name="id" required="" value="${category.id }" lay-verify="required" autocomplete="off" readonly="readonly" class="layui-input layui-disabled">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="categoryname" name="name" value="${category.name }" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
                    </div>
			        <div class="layui-form-item">
