                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" action="<%=basePath%>article/add" id="form">
                                <input type="hidden" name="uid" value="${user.id }" />
                                <input type="hidden" name="content" id="content" value="" />
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" name="name" id="name"  placeholder="请输入文章名" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <button class="layui-btn" id="sub"  type="button" >保存文章</button>
                                </div>
                            </form>
                        </div>
                    </div>
