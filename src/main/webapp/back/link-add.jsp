...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<%=basePath%>link/add" id="form">
                <input type="hidden" name="uid" value="${user.id }" />
                    <div class="layui-form-item">
                        <label for="tagname" class="layui-form-label">
                            <span class="x-red">*</span>连接名</label>
                        <div class="layui-input-inline">
                            <input type="text" id="tagname" name="name" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="href" name="href" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    </div>
			        <div class="layui-form-item">
